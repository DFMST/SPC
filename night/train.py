...
from utils import (
    ...
    visualize_physics, debug_semantic_categories
)
...
def parse_args():
    ...
    parser.add_argument("--resume", type=str, default="output/checkpoints/sem_cyclegan_epoch_40.pth", help="Path to checkpoint to resume from")
...
def main():
    ...
    best_val_iou = 0.0
    print("开始训练...")
    # debug_semantic_categories(model, train_loader_A, args.device)
