...
def main():
    ...
    parser.add_argument("--model_path", type=str, default="./output/checkpoints/final_epoch_100.pth",
                        help="训练好的模型路径(.pth文件)")
    parser.add_argument("--data_dir", type=str, default="../eva_data/snow",
                        help="数据集根目录")
    parser.add_argument("--output_dir", type=str, default="../output_data_9.2",
                        help="输出目录")
